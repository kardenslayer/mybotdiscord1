...
module.exports = async (client) => {
        ...
        .send({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(`<a:Music:1047521233077534820>  ** [\`${song.name.substring(0, 40)}\`](${song.url}) **`)
              .addFields([
                {
                  name: `Duration`,
  ...
  let Btn = ["create_ticket","close_ticket","open_ticket","tr_ticket","delete_ticket","yea_del","dont_del"]
  let ttt = ["accept","decline","a1","a2","a3","b1","b2","b3","c1","c2","c3","rock","paper","scissors","deny-ttt","accept-ttt"]
  let cal = ["cal-Clear","cal-7","cal-4","cal-1","cal-.","cal-(","cal-8","cal-5","cal-2","cal-0","cal-)","cal-9","cal-6","cal-3","cal-00","cal-=","cal-+","cal--","cal-*","cal-/","cal-⌫","cal-%","cal-^","cal-π","cal-Delete"]
  try {
    client.on("interactionCreate", async (interaction) => {
      ...
      if (interaction.isButton()) {
        ...
        if(ttt.includes(interaction.customId)) return;        
